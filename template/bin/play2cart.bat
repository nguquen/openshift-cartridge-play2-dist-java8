@REM play2cart launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM PLAY2CART_config.txt found in the PLAY2CART_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%PLAY2CART_HOME%"=="" set "PLAY2CART_HOME=%~dp0\\.."

set "APP_LIB_DIR=%PLAY2CART_HOME%\lib\"
...
set "CFG_FILE=%PLAY2CART_HOME%\PLAY2CART_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running play2cart.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !PLAY2CART_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
